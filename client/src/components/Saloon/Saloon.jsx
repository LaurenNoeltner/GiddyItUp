                            ...
                            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel" data-interval="false">
                                ...
                                <div className="carousel-inner">
                                    <div className="carousel-item active">
                                        <img src={DeputyOne} alt="DeputyOne" width="150" height="200" />
                                    </div>
                                    <div className="carousel-item">
                                        <img src={DeputyTwo} alt="DeputyTwo" width="150" height="200" />
                                    </div>
                                    <div className="carousel-item">
                                        <img src={DeputyThree} alt="DeputyThree" width="150" height="200" />
                                    </div>
                                    <div className="carousel-item">
                                        <img src={DeputyFour} alt="DeputyFour" width="150" height="200" />
                                    </div>
                                </div>
